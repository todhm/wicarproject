...
class CarVacationSetting extends Component {
    ...
    onSelectSlot=(e)=>{
        ...
        const selectedDate= e.start.setHours(0,0,0,1);
    ...
    submitForm=(e)=>{
        ...
        if(this.props.addData){
            this.props.addCarVacation(this.props.carId,values);
        }
        else{
            values['id'] = this.props.scheduleId;
            this.props.updateCarVacation(this.props.carId,values);
        }
    }
    ...
    componentDidMount = () => {
        if(this.props.carId){
            this.props.getCarVacation(this.props.carId);
        }
    }
...
export default connect(PriceSettingReducerStateToProps,priceAction)(CarVacationSetting);
